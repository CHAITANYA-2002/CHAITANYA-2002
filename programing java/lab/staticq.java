 ...
 * Static  Member functions : 
 ...
 contoleed flow statements: break continue loops etc
 sequential programming  -- no loops no classes etc ;
 conditional and decision making programming 
...
/*
 * static member function are not the part of any object but its the part of the
 * class
 * although static members are not the paft of objects , instead all the objects
 * can useits values /
 * static members are kept seerately and hecnce thier valyue is unique for all
 * the objects
 * 
 * 
 * Static Member functions :
 ...
 * 
 * condition statements:
 * condition statemets are noneother the if else and theswitch case statements
 * they are used in the code by the programmers in order to perform a joint
 * conditionas pictorially shown in the activit digrams
 * more over they follow the true and false protocols in order to perform the
 * same.
 * 
 * 
 */
