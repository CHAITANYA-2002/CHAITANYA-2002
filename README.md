...
[![Linkedin: chaitanya](https://img.shields.io/badge/-chaitanya-blue?style=flat-square&logo=Linkedin&logoColor=white&link=https://www.linkedin.com/in/)](https://www.linkedin.com/in/chaitanya-khurana-4b24991bb/)
...
const chaitanya = {
    pronouns: "He" | "Him",
    code: ["C/C++", "Python", "YAML", "Qiskit"],
    askMeAbout: ["Competitive Programming", "Tech", "MLOps", "Inovation"],
    technologies: {
        machine_learning: [Scikit-Learn,Numpy, Scipy, Catboost, PyCaret, NLTK, SpaCy],
        ci/cd: [Jenkins, Travis CI, ECS, Docker],
        
        databases: [ "MySql", MongoDb],
        deep_learning: [Tensorflow/Keras, PyTorch (beginner), OpenCV, HuggingFace(beginner)],
